...
exports.createStudent = async (data) => {
    const {
        first_name, last_name, email, phone_no, dob, gender, address,
        city, state, pin_code, country, registration_date, created_by
    } = data;
    ...
    const [result] = await sequelize.query(query, [
        first_name, last_name, email, phone_no, dob, gender, address,
        city, state, pin_code, country, registration_date, created_by, "active"
    ]);
...
exports.updateStudent = async (id, data) => {
    const {
        first_name, last_name, email, phone_no, dob, gender, address,
        city, state, pin_code, country, modified_by
    } = data;
    ...
    const [result] = await sequelize.query(query, [
        first_name, last_name, email, phone_no, dob, gender, address,
        city, state, pin_code, country, modified_by, id
    ]);
...
exports.deleteStudent = async (id) => {
    ...
    const [result] = await db.sequelizequery(query, [id]);
    return result.affectedRows > 0;
};
